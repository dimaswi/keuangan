        ...
        <div style="font-size: 14px">
            <div style="margin-left: 20px;">
                @if ($getRecord()->ruangan == 'Laboratorium')
                    ...
                    <x-filament::modal width="5xl" id="coa">
                        ...
                        <livewire:keuangan.coa.create-coa :kredit="$getRecord()->karcis" />
                    </x-filament::modal>
                ...
                @else
                    ...
                    <x-filament::modal width="5xl" id="coa">
                        ...
                        <livewire:keuangan.coa.create-coa :kredit="0" />
                    </x-filament::modal>
                @endif
            ...
            <div style="margin-left: 20px;">
                ...
                <x-filament::modal width="5xl" id="coa">
                    ...
                    <livewire:keuangan.coa.create-coa :kredit="$getRecord()->umum" />
                </x-filament::modal>
            </div>
            <div style="margin-left: 20px;">
                ...
                <x-filament::modal width="5xl" id="coa">
                    ...
                    <livewire:keuangan.coa.create-coa :kredit="$getRecord()->bpjs" />
                </x-filament::modal>
            </div>
            ...
            <div style="margin-left: 20px;">
                ...
                <x-filament::modal width="5xl" id="coa">
                    ...
                    <livewire:keuangan.coa.create-coa :kredit="$getRecord()->asuransi_karyawan" />
                </x-filament::modal>
            </div>
            ...
            <div style="margin-left: 20px;">
                ...
                <x-filament::modal width="5xl" id="coa">
                    ...
                    <livewire:keuangan.coa.create-coa :kredit="$getRecord()->jasa_raharja" />
                </x-filament::modal>
            </div>
        </div>
